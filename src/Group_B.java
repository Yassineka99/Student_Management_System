...
public class Group_B extends javax.swing.JFrame {
String sql ="select * from student where group_n='B'";
...
String last ;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Group_B.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
