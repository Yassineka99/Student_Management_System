...
public class Group_C extends javax.swing.JFrame {
String sql ="select * from student where group_n='C'";
...
String last ;
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 20, -1, 240));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Group_C.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
