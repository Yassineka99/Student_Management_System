...
String group ;
    ...
    public Students_list() {
        ...
        try {
            ...
            while(rs.next())
            {
                ...
                group=String.valueOf(rs.getString("group_n"));
            String tab[] ={id,name,last,group};
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Last Name", "Group"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 20, -1, 360));
